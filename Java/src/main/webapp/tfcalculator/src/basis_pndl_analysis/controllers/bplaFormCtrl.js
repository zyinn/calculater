    ...
    var moduleDef = [
        ...
        function ($scope, $injector, $sce, $state, $filter, commonService, bplaService, routeConst) {
            ...
            $scope.onFutureContractChange = function () {
                // commonService.setPropertyX($scope, "vm.selectChartPoint.alterColumn2", $scope.vm.selectedFutureContract.tfId);
            ...
            function doCalCulateForBondCode(selectedCode) {
                $scope.vm.responseDto.bondKey = selectedCode.bondKey;
                $scope.vm.responseDto.bondCode = selectedCode.bondCode;
                $scope.vm.responseDto.bondListedMarket = selectedCode.listedMarket;
            ...
            $scope.onBondCodeChange = function () {
                ...
                if (selected) {
                    doCalCulateForBondCode(selected);
                }
            };
