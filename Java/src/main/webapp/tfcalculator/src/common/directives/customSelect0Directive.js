...
define(['angular', 'app', 'jquery', 'directiveUtilService'], function (angular, appModule) {
    ...
    appModule.directive('customSelect0Directive', ['$sce', 'directiveUtilService', function ($sce, directiveUtilService) {
        ...
        var seq = 0;
            ...
            return {
                restrict : 'A',
                replace : true,
                // templateUrl : 'common/directives/customSelect0Template.html',
                ...
                compile: function (el, attr) {
                    return {
                        pre: function preLink(scope, element, attributes) {
                            ...
                            var selectWidth = +attributes.renderwidth || element[0].clientWidth;
                            // var selectHeight = parseFloat(element.css("height").replace("px"));
                            var selectHeight = +attributes.renderheight || element[0].clientHeight;
